      ...
      <div className="flex bg-white w-4/5 h-[92vh] rounded-md relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col m-10">
          ...
          <p className="text-2xl text-red-600 font-bold">
            ₹{prices.regular} - ₹{prices.extralarge}
          </p>
          <p className="text-lg text-gray-500 pt-6">{description}</p>
          ...
          <div className="text-xl text-red-600 font-bold pb-8">
            ${prices.regular}
          </div>
          <div className="flex gap-2">
            <div className="flex-1 text-center bg-red-700 text-white p-3 uppercase text-sm font-semibold tracking-wide">
              Add to cart
            </div>
            <div className="flex-1 text-center bg-gray-200 text-gray-800 p-3 uppercase text-sm font-semibold tracking-wide">
              Save to Favourite
            </div>
          </div>
        </div>
